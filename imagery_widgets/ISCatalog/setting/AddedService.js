        ...
        [_WidgetBase, _TemplatedMixin],
        {
            ...
            setSortSelects: function (fields) {
                ...
                for (i = 0; i < fields.length; i++) {
                    ...
                    if ((currentField.type === "esriFieldTypeDate" || currentField.DataType === "DATE") && (currentFieldNameLower.indexOf("acquisition") >= 0) && !foundAcq) {
                        foundAcq = true;
            ...
            setDisplayFields: function (fields) {
                ...
                for (i = 0; i < fields.length; i++) {
                    currField = fields[i];
                    currField.name = fields[i].name ? fields[i].name : fields[i].Name;
